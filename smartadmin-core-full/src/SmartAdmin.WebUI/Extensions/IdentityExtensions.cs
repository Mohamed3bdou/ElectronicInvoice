...
namespace SmartAdmin.WebUI.Extensions
{
    public static class IdentityExtensions
    {
        ...
        [DebuggerStepThrough]
        public static async Task<IdentityResult> UpdateAsync<T>(this ConfigDbContext context, T model, string id) where T : class
        {
        ...
        [DebuggerStepThrough]
        public static async Task<IdentityResult> DeleteAsync<T>(this ConfigDbContext context, string id) where T : class
        {
            var entity = await context.FindAsync<T>(id);
